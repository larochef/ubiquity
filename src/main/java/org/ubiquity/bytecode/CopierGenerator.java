...
class CopierGenerator {
    ...
    private void createConstructor(ClassWriter writer, String className) {
    ...
    private void createNewInstance(ClassWriter writer, String className, String destinationName) {
        Label label1 = new Label();
        Label label2 = new Label();
    ...
    private void createNewArray(ClassWriter writer, String className, String destinationName) {
    ...
    private void createCopyBridge(ClassWriter writer, String className, String srcName, String destinationName) {
        Label label1 = new Label();
        Label label2 = new Label();
...
//                visitor.visitLdcInsn(Type.getType(descriptionSetter));
    ...
    public <T> Copier<T, T> createCopier(Class<T> clazz, CopyContext ctx)
